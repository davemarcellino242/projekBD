...
public class CheckSertificate {
    ...
    public void initialize(){
        try(Connection conn = DBConnector.connect()){
            String query = "SELECT * FROM peserta_kegiatan p\n" +
                    "JOIN data_registrasi_kegiatan d ON (p.registrasi_id = d.registrasi_id)\n" +
            ...
            while (rs.next()){
                ...
                temp += "ID kegiatan : "+rs.getString("kegiatan_id")+"\n";
                temp += "Nama Club : "+rs.getString("nama_club")+"\n";
                temp += "Sertifikat : "+rs.getString("sertifikat_peserta")+"\n";
                temp += "========================================================\n";
                count++;
            }
